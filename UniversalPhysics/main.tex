...
\exercise{12}$\left(\frac{1}{r_2}-\frac{1}{r_1}\right)GMm$ 
\begin{gather*}
...
\exercise{22} 记x为链条右端的位移，l为桌边链条的长度。
\begin{align*}
dA	&=F\cdot\di{x}\\
&=F\di{x}
\end{align*}
...
\exercise{12}$ m\sqrt{2gh} $ \hspace{4em} 竖直向下
...
\exercise{15}$2350kg\cdot m/s$ \hspace{2em} 与跑弹飞行方向相反
...
\exercise{23}$\Delta x=31.36m,\Delta\theta=78.4rad.(g=9.8m/s^2)$
